  ...
  return (
    <div className="relative mx-auto w-full max-w-xl md:max-w-md">
      <button
        ...
        className={clsx(
          'ui-control flex w-full items-center justify-between rounded-2xl px-4 py-3 text-left font-sans',
      ...
      {open && !disabled && (
        <div
          ...
          className="ui-menu absolute top-full right-0 left-0 z-50 mt-2 max-h-64 overflow-auto rounded-2xl outline-none"
        >
